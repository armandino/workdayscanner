...
/**
 * <p>Java class for Custom_ID_TypeObjectType complex type.
 * 
...
@XmlType(name = "Custom_ID_TypeObjectType", propOrder = {
    "id"
})
public class CustomIDTypeObjectType {
     ...
     * {@link CustomIDTypeObjectIDType }
     * 
     * 
     */
    public List<CustomIDTypeObjectIDType> getID() {
        if (id == null) {
            id = new ArrayList<CustomIDTypeObjectIDType>();
        }
        return this.id;
    }

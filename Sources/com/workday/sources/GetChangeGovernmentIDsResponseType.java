 ...
 * 
 * <p>Java class for Get_Change_Government_IDs_ResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Get_Change_Government_IDs_ResponseType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="Request_References" type="{urn:com.workday/bsvc}Get_Change_Government_IDs_Request_ReferencesType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="Response_Data" type="{urn:com.workday/bsvc}Change_Government_IDs_Response_DataType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "Get_Change_Government_IDs_ResponseType", propOrder = {
    "requestReferences",
    "responseFilter",
    "responseResults",
    "responseData"
})
public class GetChangeGovernmentIDsResponseType {

    @XmlElement(name = "Request_References")
    protected List<GetChangeGovernmentIDsRequestReferencesType> requestReferences;
    ...
    protected List<ChangeGovernmentIDsResponseDataType> responseData;
     ...
     * 
     */
    public List<GetChangeGovernmentIDsRequestReferencesType> getRequestReferences() {
        if (requestReferences == null) {
            requestReferences = new ArrayList<GetChangeGovernmentIDsRequestReferencesType>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ChangeGovernmentIDsResponseDataType }
     * 
     * 
     */
    public List<ChangeGovernmentIDsResponseDataType> getResponseData() {
        if (responseData == null) {
            responseData = new ArrayList<ChangeGovernmentIDsResponseDataType>();
        }

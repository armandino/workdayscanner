...
/**
 * <p>Java class for External_Field_and_Parameter_Initialization_ProviderObjectType complex type.
 * 
...
@XmlType(name = "External_Field_and_Parameter_Initialization_ProviderObjectType", propOrder = {
    "id"
})
public class ExternalFieldAndParameterInitializationProviderObjectType {
     ...
     * {@link ExternalFieldAndParameterInitializationProviderObjectIDType }
     * 
     * 
     */
    public List<ExternalFieldAndParameterInitializationProviderObjectIDType> getID() {
        if (id == null) {
            id = new ArrayList<ExternalFieldAndParameterInitializationProviderObjectIDType>();
        }
        return this.id;
    }

 ...
 * 
 * <p>Java class for Get_Difficulty_to_Fill_ResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Get_Difficulty_to_Fill_ResponseType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="Request_References" type="{urn:com.workday/bsvc}Difficulty_to_Fill_Request_ReferencesType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="Response_Data" type="{urn:com.workday/bsvc}Difficulty_to_Fill_Response_DataType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "Get_Difficulty_to_Fill_ResponseType", propOrder = {
    "requestReferences",
    "responseFilter",
    "responseResults",
    "responseData"
})
public class GetDifficultyToFillResponseType {

    @XmlElement(name = "Request_References")
    protected List<DifficultyToFillRequestReferencesType> requestReferences;
    ...
    protected List<DifficultyToFillResponseDataType> responseData;
     ...
     * {@link DifficultyToFillRequestReferencesType }
     * 
     * 
     */
    public List<DifficultyToFillRequestReferencesType> getRequestReferences() {
        if (requestReferences == null) {
            requestReferences = new ArrayList<DifficultyToFillRequestReferencesType>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DifficultyToFillResponseDataType }
     * 
     * 
     */
    public List<DifficultyToFillResponseDataType> getResponseData() {
        if (responseData == null) {
            responseData = new ArrayList<DifficultyToFillResponseDataType>();
        }

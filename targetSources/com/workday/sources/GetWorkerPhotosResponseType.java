 ...
 * 
 * <p>Java class for Get_Worker_Photos_ResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Get_Worker_Photos_ResponseType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="Response_Data" type="{urn:com.workday/bsvc}Worker_Photos_Response_DataType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "Get_Worker_Photos_ResponseType", propOrder = {
    "requestReferences",
    "responseFilter",
    "responseResults",
    "responseData"
})
public class GetWorkerPhotosResponseType {
    ...
    protected List<WorkerPhotosResponseDataType> responseData;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link WorkerPhotosResponseDataType }
     * 
     * 
     */
    public List<WorkerPhotosResponseDataType> getResponseData() {
        if (responseData == null) {
            responseData = new ArrayList<WorkerPhotosResponseDataType>();
        }
